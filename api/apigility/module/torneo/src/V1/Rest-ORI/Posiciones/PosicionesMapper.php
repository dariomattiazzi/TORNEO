...
class PosicionesMapper
{
  ...
  public function fetchAll()
  {
    ...
    // $fase_en_juego HAGO ESTE CONTROL XQ SI LA FASE ES MAYOR A 1 NO MUESTRO TABLA DE Posiciones
		...
		//print_r($zona[0]['zona_mostrar_posicion']); die;
		$fase_en_juego = $zona[0]['zona_mostrar_posicion'];
