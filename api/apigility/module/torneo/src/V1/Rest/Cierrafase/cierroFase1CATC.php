...
class cierroFase1CATC {
	public function __construct($adapter) {
		$this->adapter = $adapter;
	}

	public function getCierroFase1CATC($torneo_id, $categoria_id, $zona_id, $fase_id){
...
//		 die;
		...
		if ($categoria['0']['categoria_juega_coparevancha'] == '1'){
			...
			if($equipos_CopaRevancha < $clasif_CopaRevancha){ //SI LA CANTIDAD DE EQUIPOS QUE QUEDAN PARA JUGAR LA COPA REVANCHA ES MENOR LA LA INGRESADA EN LA TABLA DE CATEGORIA, LOS PRIMEROS "X" QUEDAN LIBRE.
